      ...
      <Dropdown.Root>
        ...
        <Dropdown.DropdownMenuTrigger>
          <input
            ...
            className="w-100 sm:w-100 md:w-40 lg:w-80 rounded-md bg-slate-100 text-sm px-2"
        ...
        <Dropdown.Portal>
          <Dropdown.Content className='bg-slate-100 w-80 p-3 flex-col space-y-3 sm:w-50'>
              ...
              {people.map((person) => {
                return(
                  <Dropdown.Item key={person.id} className='flex gap-6 hover:bg-slate-300 rounded-md p-2'>
                    <img src={person.img}
